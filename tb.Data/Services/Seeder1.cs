...
//             var pupil1 = svc.AddUser(
//                 new User { FirstName = "Pupil1", LastName = "", Email = "pupil1@mail.com", Password =  "pupil1", Role =  Role.Pupil, Dob = new DateTime(2010,1,1) }
//             );
//             var pupil2 = svc.AddUser(
//                 new User { FirstName = "Pupil2", LastName = "", Email = "pupil2@mail.com", Password =  "pupil2", Role =  Role.Pupil, Dob = new DateTime(2000,1,1) }
//             );
//             var pupil3 = svc.AddUser(
//                 new User { FirstName = "Pupil3", LastName = "", Email = "pupil3@mail.com", Password =  "pupil3", Role =  Role.Pupil, Dob = new DateTime(1990,4,1) }
//             );
//             var pupil4 = svc.AddUser(
//                 new User { FirstName = "Pupil4", LastName = "", Email = "pupil4@mail.com", Password =  "pupil4", Role =  Role.Pupil, Dob = new DateTime(1995,10,1) }
//             );
//             var pupil5 = svc.AddUser(
//                 new User { FirstName = "Pupil5", LastName = "", Email = "pupil5@mail.com", Password =  "pupil5", Role =  Role.Pupil, Dob = new DateTime(1989,3,1) }
//             );
//             var pupil6 = svc.AddUser(
//                 new User { FirstName = "Pupil6", LastName = "", Email = "pupil6@mail.com", Password =  "pupil6", Role =  Role.Pupil, Dob = new DateTime(2003,5,1) }
//             );
          
//             //add students
//             var s1 = new Student
//             {   
//                 User = pupil1, // student has user account p1
...
//             };
//             var student1 = svc.AddStudent(pupil1, s1); 
...
//                 LessonTwoDay = Core.Models.DaysOfWeek.NA
//             };
//             var student2 = svc.AddStudent(pupil2,s2); 
...
//                 LessonTwoDay = Core.Models.DaysOfWeek.NA
//             };
//             var student3 = svc.AddStudent(pupil3, s3); 
...
//                 LessonTwoDay = Core.Models.DaysOfWeek.NA
//             };
//             var student4 = svc.AddStudent(pupil4, s4); 
...
//                 LessonTwoDay = Core.Models.DaysOfWeek.NA
//             };
//             var student5 = svc.AddStudent(pupil5, s5); 
